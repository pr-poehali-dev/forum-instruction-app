              ...
              variants: [
                {
                  ...
                  steps: [
                    {
                      text: 'Заблаговременно до проведения турнира необходимо забронировать 1 из спорт-залов. Инструкция бронирования находиться в разделе "За 2-3 недели до форума"',
                    },
                    {
                      text: 'Для получения инвентаря необходимо связаться с Шамилем Кирамовым',
                      contact: '@ShamilKiramov_SAOK',
                    },
                    {
                      text: 'За день до форума инвентарь необходимо забрать и самостоятельно доставить на место проведения турнира',
                    },
                  ],
                },
              ],
              ...
              variants: [
                {
                  ...
                  steps: [
                    {
                      text: 'За неделю до мероприятия необходимо направить списки с ФИО и фотографиями паспортов (первые страницы) всех присутствующих на экскурсии на почту РП САОК Дьяконову Леониду Андреевичу (ldyakonov@alabuga.ru), в письме укажите дату и время проведения экскурсии, в копию необходимо поставить Оганесян Карину (KOganesyan@alabuga.ru) и Дмитриева Вадима (VaADmitriev@alabuga.ru, для согласования с СБ)',
                    },
                  ],
                },
              ],
              ...
              variants: [
                {
                  ...
                  steps: [
                    {
                      text: 'Необходимо запросить согласование проведения у экскурсии РП СААЖ 1 уровня Тихоновой Людмилы Васильевны.\n\nДля этого необходимо направить Людмиле Васильевне (LTikhonova@alabuga.ru) письмо с указанием: даты и времени проведения экскурсии, места проведения экскурсии (Пирамида) и количеством присутствующих.\n\nПосле согласования экскурсию проводят администраторы Пирамиды.',
                    },
                  ],
                },
              ],
